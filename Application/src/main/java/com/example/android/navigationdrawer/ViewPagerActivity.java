...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "chicken.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_1));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "pizza.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_2));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "ricecake.jpg"));
